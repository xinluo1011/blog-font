    ...
    <div>
        ...
        <el-table :data="tableData" border stripe @selection-change="handleSelectionChange" >
            ...
            <el-table-column label="是否推荐">
                <template slot-scope="scope">
                    <el-switch @change="changeRecommend(scope.row)" v-model="scope.row.isRecommend"></el-switch>
                </template>
            </el-table-column>
            ...
            <el-table-column label="操作" width="200" align="center">
                <template slot-scope="scope" >
                    <el-button type="warning" @click="handleEdit(scope.row)" v-if="scope.row.uid === parseInt(user.userId)">编辑<i class="el-icon-edit"></i></el-button>
                    <el-popconfirm
                            class="ml-5"
                            confirm-button-text='确定'
                            cancel-button-text='我再想想'
            ...
            <el-form label-width="80px" size="small">
                <el-form-item label="封面图">
                    <el-upload
                        ...
                        <img v-if="form.turl" :src="form.turl" class="avatar">
                ...
                <el-form-item label="分类">
                    <el-select clearable v-model="form.cid" placeholder="请选择" style="width: 100%">
...
<script>
    ...
    export default {
        ...
        methods:{
            changeRecommend(row){
                this.request.post('/blog/save',row).then((res)=>{
                    if(res){
